...
class MyRNN(keras.Model):
    def __init__(self, units):
        ...
        self.rnn = Sequential([layers.GRU(units=units, return_sequences=True, dropout=0.5),
                               layers.GRU(units=units, return_sequences=True, dropout=0.5),
                               layers.GRU(units=units, dropout=0.5)
                               ])
